...
@configclass
class HSRBLiftPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 96
    max_iterations = 15000
    save_interval = 100
    experiment_name = "hsrb_lift_PPO"
    run_name = ""
    resume = False
...
@configclass
class HSRBLiftDPPORunnerCfg(RslRlRunnerCfg):
    num_steps_per_env = 96
    max_iterations = 15000
    save_interval = 500
    experiment_name = "hsrb_lift_DPPO"
...
@configclass
class HSRBLiftDPPOMultiInputRunnerCfg(RslRlRunnerCfg):
    num_steps_per_env = 96
    max_iterations = 10000
    save_interval = 500
    experiment_name = "hsrb_lift_DPPO_multi_input"
    empirical_normalization = True
...
@configclass
class HSRBLiftDPPOMultiTeacherRunnerCfg(RslRlRunnerCfg):
    num_steps_per_env = 48
    max_iterations = 10000
    save_interval = 100
    experiment_name = "hsrb_lift_DPPOMulti_teacher"
    empirical_normalization = True
    policy = RslRlDppoMultiInputAlgorithmCfg(
        actor_noise_std=1.0,
        actor_hidden_dims=[256, 128, 64],
...
@configclass
class HSRBLiftPPOMultiTeacherRunnerCfg(RslRlPPORunnerCfg):
    num_steps_per_env = 48
    max_iterations = 10000
    save_interval = 100
    experiment_name = "hsrb_lift_PPOMulti_teacher"
    empirical_normalization = True
...
@configclass
class HSRBLiftDPPOMultiStudentRunnerCfg(HSRBLiftDPPOMultiTeacherRunnerCfg):
    experiment_name = "hsrb_lift_DPPOMulti_student"
    max_iterations = 100000

@configclass
class HSRBLiftPPOMultiStudentRunnerCfg(HSRBLiftPPOMultiTeacherRunnerCfg):
    experiment_name = "hsrb_lift_PPOMulti_student"
    max_iterations = 100000
    
#### CVaR Runner Configs ####
@configclass
class HSRBLiftDPPOMultiCVaRTeacherRunnerCfg(HSRBLiftDPPOMultiTeacherRunnerCfg):
    experiment_name = "hsrb_lift_DPPOMulti_CVaR_teacher"
    algorithm = RslRlDppoAlgorithmCfg(
        class_name="DPPOMulti",
        critic_network="multi_qrdqn",
        value_coeff=0.9,
...
@configclass
class HSRBLiftDPPOMultiCVaRStudentRunnerCfg(HSRBLiftDPPOMultiCVaRTeacherRunnerCfg):
    experiment_name = "hsrb_lift_DPPOMulti_CVaR_student"
    max_iterations = 100000
    
#### Neutral Runner Configs ####
@configclass
class HSRBLiftDPPOMultiNeutralTeacherRunnerCfg(HSRBLiftDPPOMultiTeacherRunnerCfg):
    experiment_name = "hsrb_lift_DPPOMulti_Neutral_teacher"
    algorithm = RslRlDppoAlgorithmCfg(
        class_name="DPPOMulti",
        critic_network="multi_qrdqn",
        value_coeff=0.9,
...
@configclass
class HSRBLiftDPPOMultiNeutralStudentRunnerCfg(HSRBLiftDPPOMultiNeutralTeacherRunnerCfg):
    experiment_name = "hsrb_lift_DPPOMulti_Neutral_student"
    max_iterations = 100000