...
class StudentCurriculumCfg(CurriculumCfg):
    ...
    action_rate = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "action_rate", "weight": -0.0001, "num_steps": 1} # Update after 1 iterations
    )

    arm_joint_vel = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "arm_joint_vel", "weight": -0.0025, "num_steps": 1}
    )
    
    base_vel = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "base_vel", "weight": -0.005, "num_steps": 1}
    )
    ...
    #     func=mdp.modify_reward_weight, params={"term_name": "termination_penalty", "weight": -50.0, "num_steps": 1} # 1 iterations
    # )

    ee_acc = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "ee_acc", "weight": -0.0025, "num_steps": 1} # 1 iterations
    )
...
@configclass
class HSRBGridStudentEnvCfg(HSRBGridExperimentEnvCfg):
...
@configclass
class HSRBGridStudentEnvCfg_PPO(HSRBGridStudentEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class HSRBGridStudentEnvCfg_PLAY(HSRBGridStudentEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class HSRBGridStudentEnvCfg_PPO_PLAY(HSRBGridStudentEnvCfg_PPO):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # make a smaller scene for play
