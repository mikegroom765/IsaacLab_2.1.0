...
class CommandsCfg:
    ...
    object_goal_region: mdp.GoalRegionCommandCfg = MISSING
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        target_object_position = ObsTerm(func=mdp.generated_commands, params={"command_name": "object_goal_region"})
...
class EventCfg:
    ...
    reset_base: EventTerm | None = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (-0.1, 0.1), "y": (-0.1, 0.1), "z": (0.0, 0.0), "yaw": (0.0, 0.0)},
            "velocity_range": {
                "x": (-0.0, 0.0),
                "y": (-0.0, 0.0),
                "z": (-0.0, 0.0),
...
class RewardsCfg:
    ...
    object_goal_tracking = RewTerm(
        ...
        params={"std": 0.3, "minimal_height": 0.04, "command_name": "object_goal_region"},
        weight=16.0,
    )

    object_goal_tracking_fine_grained = RewTerm(
        func=mdp.object_goal_distance,
        params={"std": 0.05, "minimal_height": 0.04, "command_name": "object_goal_region"},
        weight=5.0,
    )
