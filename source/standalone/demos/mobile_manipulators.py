...
"""
This script demonstrates different mobile manipulators.

.. code-block:: bash

    # Usage
    ./isaaclab.sh -p source/standalone/demos/mobile_manipulators.py
...
parser = argparse.ArgumentParser(description="This script demonstrates different mobile manipulators.")
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # -- Robot
    hsrb = Articulation(HSRB_CFG.replace(prim_path="/World/Origin1/Robot"))
